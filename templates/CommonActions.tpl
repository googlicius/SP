        ...
        <div class="actionsContainer row-fluid">
            ...
            <div class="span10">
                <div class="row-fluid">
                    ...
                    <div class="notificationMessageHolder span1">
                        
                    </div>
                    <div class="nav quickActions btn-toolbar span3 pull-right marginLeftZero">
                        <div class="pull-right commonActionsButtonContainer">
                            <!-- Added by haidang009 -->
                            <span>{vtranslate('Capture global search',$MODULE_NAME)} </span>
                            <input type="checkbox" class="checkbox-on-off" checked>
                            <!-- End added -->
